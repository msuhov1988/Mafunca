...
from mafunca.aff_trans.build import AffResult, pure_success
from mafunca.aff_trans.direct import ap
...
def lift2(
    ...
    panic_on_coroutine(fn, 'AffResult', 'lift2')     
...
def lift3(
    ...
    """:raises MonadError: coroutine function is not allowed"""
    panic_on_coroutine(fn, 'AffResult', 'lift3')    
...
def lift4(
    ...
    """:raises MonadError: coroutine function is not allowed"""
    panic_on_coroutine(fn, 'AffResult', 'lift4')    
